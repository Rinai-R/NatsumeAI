...
func (c *paymentServiceClient) GetPayment(ctx context.Context, in *GetPaymentReq, opts ...grpc.CallOption) (*GetPaymentResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedPaymentServiceServer) GetPayment(context.Context, *GetPaymentReq) (*GetPaymentResp, error) {
