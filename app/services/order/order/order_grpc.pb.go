...
const (
	...
	OrderService_MarkPaying_FullMethodName     = "/order.OrderService/MarkPaying"
...
type OrderServiceClient interface {
	...
	// 将订单标记为支付中并启动支付超时逻辑
	MarkPaying(ctx context.Context, in *MarkPayingReq, opts ...grpc.CallOption) (*MarkPayingResp, error)
	// 主动取消或超时取消订单
...
func (c *orderServiceClient) MarkPaying(ctx context.Context, in *MarkPayingReq, opts ...grpc.CallOption) (*MarkPayingResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MarkPayingResp)
	err := c.cc.Invoke(ctx, OrderService_MarkPaying_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServiceServer interface {
	...
	// 将订单标记为支付中并启动支付超时逻辑
	MarkPaying(context.Context, *MarkPayingReq) (*MarkPayingResp, error)
	// 主动取消或超时取消订单
...
func (UnimplementedOrderServiceServer) MarkPaying(context.Context, *MarkPayingReq) (*MarkPayingResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MarkPaying not implemented")
}
...
func _OrderService_MarkPaying_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MarkPayingReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServiceServer).MarkPaying(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderService_MarkPaying_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).MarkPaying(ctx, req.(*MarkPayingReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OrderService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "MarkPaying",
			Handler:    _OrderService_MarkPaying_Handler,
		},
		{
